...
export class ApiService {
  ...
  updateDeviceTxPower(data) {
    const httpOptions = {
      headers: new HttpHeaders({ 'Content-Type': 'application/json' }),
    };

    let url = this.host + '/updateDeviceTxPower'
    let body = {
      data: data,
    };
    return new Promise((resolve, reject) => {
  ...
  updateCoinPlacement(data) {
    const httpOptions = {
      headers: new HttpHeaders({ 'Content-Type': 'application/json' }),
    };

    let url = this.host + '/updateCoinPlacement'
    let body = {
      data: data,
    };
    return new Promise((resolve, reject) => {
  ...
  userFeature(data){
    ...
    let url = this.host + '/updateSettingFeatures'
    let body = {
      data: data,
    };
    return new Promise((resolve, reject) => {
